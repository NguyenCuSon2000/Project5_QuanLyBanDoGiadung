...
namespace QuanLyBanDoGiaDung_API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        private string SaveFileFromBase64String(string RelativePathFileName, string dataFromBase64String)
        {
        ...
        private string WriteFileToAuthAccessFolder(string RelativePathFileName, string base64StringData)
        {
            try
            {
                string result = "";
