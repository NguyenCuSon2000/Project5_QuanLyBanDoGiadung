(function($) {
   ...
   /****************************************
     *   Product Slider Active - 8 Grid 2 Rows
     *****************************************/
    var productSlider4grid2row = new Swiper('.product-default-slider-8grid-2row.swiper-container', {
        slidesPerView: 4,
        spaceBetween: 30,
        speed: 1500,
        slidesPerColumn: 2,
        ...
        navigation: {
            nextEl: '.product-slider-default-2row .swiper-button-next',
            prevEl: '.product-slider-default-2row .swiper-button-prev',
        },
     ...
     *   Product Slider Active - 8 Grid 2 Rows
     *****************************************/
      var productSlider4grid2row = new Swiper('.product-default-slider-device-8grid-2row.swiper-container', {
        slidesPerView: 4,
        spaceBetween: 30,
        speed: 1500,
        slidesPerColumn: 2,
        ...
        navigation: {
            nextEl: '.product-slider-default-device-2row .swiper-button-next',
            prevEl: '.product-slider-default-device-2row .swiper-button-prev',
        },
